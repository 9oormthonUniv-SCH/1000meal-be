...
class MenuServiceTest {
    ...
    void getWeeklyMenuWithGroups_whenWeeklyMissing_returnsSkeleton() {
        ...
        assertFalse(firstDay.isOpen());  // New requirement: isOpen=false for skeleton
    ...
    void getWeeklyMenuWithGroups_whenExists_returnsWithGroups() {
        ...
        assertEquals("기본 메뉴", wedResponse.getGroups().get(0).getName());
